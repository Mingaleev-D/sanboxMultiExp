package org.example.project.ui.pages.search
...
import org.example.project.ui.pages.search.components.CharacterListItem
...
fun SearchPage(
    ...
    Column(
        ...
        when (val state = screenState) {
            ...
            is SearchViewModel.ScreenState.Content -> SearchScreenContent(content = state){ id ->
        ...
        LazyColumn(
            ...
            items(content.results) { character ->
                ...
                CharacterListItem(
                       ...
                       onClick = {
                           onClickCharacterItem(character.id)
                       }
                )
            }
        }
